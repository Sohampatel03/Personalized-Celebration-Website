...
const FinalGift = () => {
  ...
  const saveWish = async (e) => {
    ...
    try {
      // Dynamically import emailjs so it doesn't block the page load
      ...
      await emailjs.send(
        ...
        {
          wish_message: trimmed,
          from_name: "Piya's Birthday Site",
          to_name: "Bhai",
          reply_to: "",
        },
      ...
      // Still save locally so user isn't stuck
      setSavedWish(trimmed);
      setSendStatus("error");
    } finally {
      setSending(false);
  ...
  return (
    ...
    >
      {/* Glow */}
      <div
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] rounded-full blur-[170px] pointer-events-none"
        ...
        <AnimatePresence mode="wait">
          {!isOpen ? (
            ...
            >
              ...
              >
                ...
                <div className="flex flex-col items-center gap-3 relative z-10">
                  ...
                  <span className="font-sans font-semibold text-white uppercase" style={{ fontSize: "0.6rem", letterSpacing: "0.38em" }}>
                    Tap to Open
                  </span>
                </div>
              </motion.button>
            ...
            >
              {/* Badge */}
              <div
                className="absolute top-3 right-3 px-2.5 py-1 rounded-full font-sans font-bold uppercase"
                style={{
                  color: "var(--rose)",
              ...
              <h3
                className="font-display grad-rose leading-none mb-3"
                style={{ fontSize: "clamp(1.9rem, 7vw, 3.5rem)", letterSpacing: "-0.01em" }}
              >
                Make A Wish!
              </h3>
              <p
                className="font-sans font-light mb-10 max-w-xs"
              ...
              >
                        ...
                        {isOn ? (
                          <motion.button
                            ...
                            style={{
                              ...
                              background: "linear-gradient(to top, #f97316, #facc15, #fef9c3)",
                ...
                {/* Tier 1 */}
                <div
                  className="rounded-full relative z-0 -mt-3"
                  style={{
                    width: "100%", height: "clamp(55px,17vw,75px)",
                    background: "linear-gradient(135deg, #9333ea, #c026d3, #9333ea)",
                    border: "1px solid rgba(147,51,234,0.4)",
                    boxShadow: "0 8px 28px rgba(147,51,234,0.25)",
                  }}
                >
                ...
                <div
                  ...
                  style={{ width: "110%", height: "10px", background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.04)" }}
                />
              </div>
                ...
                {allBlown && (
                  ...
                  >
                    <div className="flex items-center gap-2 mb-4" style={{ color: "var(--rose)" }}>
                      ...
                      <span className="font-sans font-semibold uppercase" style={{ fontSize: "0.6rem", letterSpacing: "0.38em" }}>
                        Wishes Locked
                      </span>
                      <FaHeart size={11} className="animate-pulse" />
                    </div>
                    ...
                    {!savedWish ? (
                      ...
                      >
                        ...
                        >
                          ...
                          <button
                            ...
                            className="px-4 py-2 rounded-xl text-white font-sans font-bold uppercase transition-opacity"
                            style={{
                              background: "linear-gradient(135deg, var(--rose), var(--plum))",
                              fontSize: "0.6rem",
                              letterSpacing: "0.25em",
                              whiteSpace: "nowrap",
                              opacity: sending || !wish.trim() ? 0.5 : 1,
                              cursor: sending || !wish.trim() ? "not-allowed" : "pointer",
                            }}
                          >
                            {sending ? "Sending…" : "Lock Wish"}
                          </button>
                        </div>

                        {/* Subtle hint */}
                        <p className="font-sans text-center" style={{ color: "rgba(196,160,170,0.3)", fontSize: "0.62rem" }}>
                          Your wish will be sent directly to your brother ✉️
                        </p>
                      </motion.form>
                      ...
                      >
                        {sendStatus === "success" && (
                          <span className="font-sans uppercase block mb-2 text-green-400" style={{ fontSize: "0.58rem", letterSpacing: "0.3em" }}>
                            ✓ Wish delivered to his inbox!
                          </span>
                        )}
                        {sendStatus === "error" && (
                          <span className="font-sans uppercase block mb-2" style={{ color: "rgba(244,63,94,0.7)", fontSize: "0.58rem", letterSpacing: "0.3em" }}>
                        ...
                        <span
                          className="font-sans uppercase block mt-3"
                          style={{ color: "rgba(196,160,170,0.35)", fontSize: "0.58rem", letterSpacing: "0.3em" }}
                        >
                          Cast into the sky…
                        </span>
                      </motion.div>
